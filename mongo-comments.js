...
db.movies.find({rating:8},{_id: 0, name: 1})

db.movies.find({rating:8},{_id: 0, name: 1}).sort({name: 1})
...
db.movies.updateOne({ id: "105"},{ $set:{rating: 9.2} })

db.movies.deleteOne({_id: ObjectId("63299c62b467b91dcb97e9e3")})

db.movies.updateMany({},{$set: {language: "English"} })

db.movies.find({id: {$in: ["99", "103"]}})
...
db.movies.updateOne({id: "106"},{ $set: {language: "Telugu"} })
